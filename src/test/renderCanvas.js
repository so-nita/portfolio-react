function n(e) {
    ...
    Line.prototype = {
        ...
        update: function () {
            ...
            for (var i = 1; i < this.nodes.length; i++){
                ...
                t = this.nodes[i];
                // Apply forces between consecutive nodes
                t.vx += (n.x - t.x) * e;
                t.vy += (n.y - t.y) * e;

                // Apply dampening based on the previous node's velocity
                ...
                // Adjust the spring constant for the next iteration
                e *= E.tension;
            }
        },
        draw: function () {
    ...
    function onMousemove(e) {
        ...
        // Remove the need to remove event listeners if not necessary
